            ...
            <a-list :split='false'>
              <a-list-item>
                ...
                <a-tooltip slot='actions'>
                  ...
                  <a-select size='small' style='width: 80px;' v-model='contentWidth'
              ...
              <a-list-item>
                <span>固定 Header</span>
                <a-switch slot='actions' size='small' :checked='fixedHeader'
                          @change="(checked) => handleChange('fixedHeader', checked)" />
              </a-list-item>
              <a-list-item>
                <span :style="{ opacity: layout === 'topmenu' ? 0.5 : 1 }">固定侧边菜单</span>
                <a-switch slot='actions' size='small' :disabled="(layout === 'topmenu')" :checked='fixedSidebar'
                          @change="(checked) => handleChange('fixSiderbar', checked)" />
              </a-list-item>
              <a-list-item>
                <span>隐藏 Footer</span>
                <a-switch slot='actions' size='small' :defaultChecked='hideFooter'
        ...
        <setting-item title='表格通用样式' divider>
          <div>
            <a-list :split='false'>
              <a-list-item>
                <span>表格大小</span>
                <a-radio-group slot='actions' :default-value='tableSize' size='small' button-style='solid'
              ...
              <a-list-item>
                <span>显示边框</span>
                <a-switch slot='actions' size='small' :checked='tableBordered'
        ...
        <setting-item title='其他设置' divider>
          <div>
            <a-list :split='false'>
              <a-list-item>
                <span>色弱模式</span>
                <a-switch slot='actions' size='small' :checked='colorWeak'
