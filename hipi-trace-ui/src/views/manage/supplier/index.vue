    ...
    <page-header-wrapper>
      ...
      >
        ...
        <a-form-model ref='form' :model='form' :rules='rules'>
          <a-form-model-item label='供应商目录' prop='supplierCatalogueId'>
            <a-tree-select
              v-model='form.supplierCatalogueId'
              style='width: 200px'
          ...
          <a-form-model-item label='供应商编码' prop='supplierCode'>
            <a-input v-model='form.supplierCode' :clearable='true' />
          </a-form-model-item>
          <a-form-model-item label='供应商名称' prop='supplierName'>
            <a-input v-model='form.supplierName' :clearable='true' />
          </a-form-model-item>


        </a-form-model>
        <a-form-model ref='customForm' :model='customForm' :label-col='{xs: { span: 4 },sm: { span: 4 },}'>
...
import { addSupplier, delSupplier, getById, listSupplier, treeList, updateSupplier } from '@/api/supplier/index'
  ...
  data() {
    return {
      ...
      columns: [
        {
          title: '供应商目录编号',
          dataIndex: 'supplierCatalogueCode',
          align: 'center'
        },
        {
          title: '供应商目录',
          dataIndex: 'supplierCatalogueName',
          align: 'center'
        },
        {
          title: '供应商编码',
      ...
      rules: {
        supplierCatalogueId: [
          { required: true, message: '供应商目录不能为空', trigger: 'change' }
        ],
        supplierCode: [
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          this.treeOptions.forEach((el) => {
            if (el.id = data.supplierCatalogueId) {
              data.supplierCatalogueCode = el.code
            }
          })
