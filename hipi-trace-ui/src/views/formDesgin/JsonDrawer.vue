    ...
    >
      <a-spin tip='Loading...' :spinning='loading'>
        ...
        >
          ...
          <a-button icon='copy' type='primary' @click='saveJSON' style='marginRight: 8px'>
...
export default {
  ...
  methods: {
    saveJSON() {
      console.log(this.jsonEditor.getValue.fields, '888888')
      this.$emit('saveJSON', this.beautifierJson)
