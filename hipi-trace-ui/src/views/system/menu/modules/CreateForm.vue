    ...
    <a-form-model ref='form' :model='form' :rules='rules'>
      ...
      <a-form-model-item prop='visible' v-if="form.menuType != 'F'">
        ...
        <a-radio-group v-model='form.visible' button-style='solid'>
          <a-radio-button v-for='(d, index) in visibleOptions' :key='index' :value='d.dictValue'>{{ d.dictLabel }}
          </a-radio-button>
        </a-radio-group>
      </a-form-model-item>
      <a-form-model-item prop='status' v-if="form.menuType != 'F'">
        ...
        <a-radio-group v-model='form.status' button-style='solid'>
          <a-radio-button v-for='(d, index) in statusOptions' :key='index' :value='d.dictValue'>{{ d.dictLabel }}
          </a-radio-button>
        </a-radio-group>
      </a-form-model-item>
