    ...
    <page-header-wrapper>
      ...
      >
        ...
        <a-form-model ref='form' :model='form' :rules='rules'>
          <a-form-model-item label='品类编码' prop='code'>
            <a-input v-model='form.code' :clearable='true' />
          </a-form-model-item>
          <a-form-model-item label='品类名称' prop='name'>
...
import { addCategory, delCategory, getById, listCategory, treeList, updateCategory } from '@/api/digit/category'
