...
export const constantRouterMap = [
  ...
  },
  {
    ...
    name: 'form',
    hidden: true,
    component: () => import(/* webpackChunkName: "parser-example" */'@/views/formDesgin/index.vue')
  },
  {
    path: '/parser',
    name: 'parser',
  ...
  },
  {
    path: '/AMapView',
    name: 'AMapView',
    component: () => import(/* webpackChunkName: "tinymce-example" */'@/components/amap/AMapView.vue')
  }
