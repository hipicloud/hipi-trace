...
export function listChannelBusiness(query) {
  return request({
    ...
    url: '/code/distributorCatalogue/selectLastPage',
    method: 'get',
    params: query
  })
}
...
export function addChannelBusiness(data) {
  return request({
    url: '/code/distributorCatalogue/save',
    method: 'post',
    data: data
  })
}
...
export function updateChannelBusiness(data) {
  return request({
    url: '/code/distributorCatalogue/update',
    method: 'put',
    data: data
  })
}
...
export function delChannelBusiness(deptId) {
  return request({
    url: '/code/distributorCatalogue/deleteById/' + deptId,
    method: 'delete'
  })
}
...
export function getById(id) {
  return request({
    url: '/code/distributorCatalogue/getById/' + id,
    method: 'get'
  })
}
