...
export function listTraceability(query) {
  return request({
    url: '/code/traceabilityCatalogue/selectLastPage',
    method: 'get',
    params: query
  })
}
...
export function addTraceability(data) {
  return request({
    url: '/code/traceabilityCatalogue/save',
    method: 'post',
    data: data
  })
}
...
export function updateTraceability(data) {
  return request({
    url: '/code/traceabilityCatalogue/update',
    method: 'put',
    data: data
  })
}
...
export function delTraceability(deptId) {
  return request({
    url: '/code/traceabilityCatalogue/deleteById/' + deptId,
    method: 'delete'
  })
}
...
export function getById(id) {
  return request({
    url: '/code/traceabilityCatalogue/getById/' + id,
    method: 'get'
  })
}
