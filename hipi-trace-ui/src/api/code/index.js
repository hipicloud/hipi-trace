...
// 查询生码列表
export function listCodeRecord(query) {
  return request({
    url: '/code/traceQrCode/page',
    method: 'get',
    params: query
  })
}
...
export function getCategoryBatch(query) {
  return request({
    url: '/code/traceBatch/getCategoryBatch',
    method: 'get',
    params: query
  })
}
